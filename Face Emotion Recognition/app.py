...
try:
    face_classifier = cv2.CascadeClassifier(
        cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')  # Face Detection
    classifier = load_model('Final_model.h5')  # Load model
    emotion_labels = ['Angry', 'Disgust', 'Fear', 'Happy',
                      'Neutral', 'Sad', 'Surprise']  # Emotion that will be predicted
except Exception:
...
class VideoTransformer(VideoTransformerBase):
    ...
    def transform(self, frame):
        ...
        for (x, y, w, h) in faces:
            ...
            label_position = (x, y)
            b = cv2.putText(a, label, label_position,
...
def main():
    ...
    activities = ["Introduction", "Home", "Real-Time Snapshot",
                  "Check Camera", "About", "Contact Us"]
    choice = st.sidebar.selectbox("Pick something Useful", activities)
    st.sidebar.image(
        "https://pragya2002.github.io/Teaching-Made-Easy-HCI/perceptor2.png", use_column_width=True)

    if choice == "Real-Time Snapshot":
        html_temp = """
    <body style="background-color:red;">
    <div style="background-color:grey ;padding:10px">
    <h2 style="color:white;text-align:center;">Real-Time Snapshot</h2>
    </div>
    </body>
        """
        st.markdown(html_temp, unsafe_allow_html=True)
        st.title(
            ":angry::dizzy_face::fearful::smile::pensive::open_mouth::neutral_face:")
        ...
        st.write('''
		      ...
		      3. It will automatically throw the image with the prediction at that instant.
                  ...
                  5. For live recognition the app gets slower and takes more time to predict and can't predict easily thus fluctuating the result.
		         Thus, take a snapshot at any instant of time and it will automatically predict and give the picture with prediction.
		     
		      6. Easy to know what was or what is the emotion at a particular time.
                  
                  7. Click on Stop to end.
                  
                  8. If webcam window still did not open, go to Check Camera from the sidebar.''')
    ...
    <h2 style="color:white;text-align:center;">Face Emotion Recognition WebApp</h2>
        ...
        ##### Instructions for using the App:
		      ...
		      6. If webcam window still did not open, go to Check Camera from the sidebar.''')
        webrtc_streamer(
    ...
    <br>
        ...
        st.write('''
                  ...
                  ##### Instructions for Checking Camera
                  
                  1. Click on  Start  to open webcam.
                 
                  2. If you have more than one camera, then select one by using the "Select Device" option.
		  
		      3. Have some fun with your camera by choosing the options below.
                  
                  4. Click on Stop to end.
                  
                  5. If webcam window did not open, Contact Us.''')
        app_video_filters()
    ...
    <br>
        ...
        html_temp = """
    <body style="background-color:red;">
    <div style="background-color:grey ;padding:0.25px">
    <h2 style="color:white;text-align:center;">Copyright © 2021 | Pragya Awasthi</h2>
    </div>
    </body>
        """
        st.markdown(html_temp, unsafe_allow_html=True)
        ...
        html_temp = """
    <body style="">
    <div style="background: url('https://github.com/pragya2002/rickNmorty/blob/main/Frame%201%20(6).png?raw=true');  background-size: cover; height:570px;width:709px";>
    <h2 style="color:#E2DCDC;text-align:center;"></h2>
